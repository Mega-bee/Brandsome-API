...
namespace Brandsome.BLL.IServices
{
    public interface IAuthBO
    {
        ...
        Task<ResponseModel> RequestOtp(string phoneNumber, string countryCode, string userName);
        ...
        Task<ResponseModel> ResendOtp(string phoneNumber,string countryCode, string uid);
